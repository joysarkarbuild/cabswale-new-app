...
class TopPickupLocationScreen extends StatefulWidget {
  const TopPickupLocationScreen({super.key});

  @override
  State<TopPickupLocationScreen> createState() =>
      _TopPickupLocationScreenState();
}

class _TopPickupLocationScreenState extends State<TopPickupLocationScreen> {
  int selectedTab = 0;
  ...
  void initState() {
    ...
    context
        ...
        .add(FetchTopPickupLocation(0, _getCollectionName(), true, false));
  ...
  void _scrollListener() async {
    if (_scrollController.position.pixels >=
      ...
      if (context.read<TopPickupLocationBloc>().state
        ...
        context
            .read<TopPickupLocationBloc>()
            .add(LoadMorePickupLocations(false));
      }
    }
  }
          ...
          child: TabSelection(
            ...
            onTabSelected: (index) {
              ...
              context.read<TopPickupLocationBloc>().add(
                    ResetTopPickupLocation(_getCollectionName(), false),
                  );
            },
          ),
        ),
